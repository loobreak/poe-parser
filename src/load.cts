...
module.exports = require('@neon-rs/load').proxy({
  platforms: {
    'win32-x64-msvc': () => require('@poe-parser/win32-x64-msvc'),
    'darwin-x64': () => require('@poe-parser/darwin-x64'),
    'darwin-arm64': () => require('@poe-parser/darwin-arm64'),
    'linux-x64-gnu': () => require('@poe-parser/linux-x64-gnu')
  },
